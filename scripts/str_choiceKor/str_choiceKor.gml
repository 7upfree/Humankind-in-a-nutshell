...
function str_choiceKor(type){
	draw_set_halign(fa_center);
	draw_set_color(c_black);
	draw_set_font(kor35);
	draw_text(x+300, y+100, cnt_symbolKor(type, 1));
	draw_sprite_stretched(spr_symbol, type, x+250, y+150, 100, 100);
	draw_set_font(kor20);
	draw_text(x+300, y+350, cnt_symbolKor(type, 2));
	
	draw_set_font(kor20);
	if (rarity[| type] == 1) // common
	{
		draw_set_color(c_green);
		draw_text(x+300, y+70, cnt_rarityKor(rarity[| type]));
	}
