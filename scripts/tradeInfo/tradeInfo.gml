...
function tradeInfo(type){
	draw_set_halign(fa_center);
	draw_set_color(c_black);
	draw_set_font(eng26);
	draw_text(x+227.5, y+100, symbolDesc(type, 1));
	draw_sprite_stretched(spr_symbol, type, x+177.5, y+150, 100, 100);
	draw_set_font(eng14);
	draw_text(x+227.5, y+350, symbolDesc(type, 2));
	
	draw_set_font(eng18);
	if (rarity[| type] == 1) // common
	{
		draw_set_color(c_green);
		draw_text(x+227.5, y+70, rarityString(rarity[| type]));
	}
