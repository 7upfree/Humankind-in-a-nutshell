...
function tradeInfoKor(type){
	draw_set_halign(fa_center);
	draw_set_color(c_black);
	draw_set_font(kor30);
	draw_text(x+227.5, y+100, symbolDescKor(type, 1));
	draw_sprite_stretched(spr_symbol, type, x+177.5, y+150, 100, 100);
	draw_set_font(kor16);
	draw_text(x+227.5, y+350, symbolDescKor(type, 2));
	
	draw_set_font(kor16);
	if (rarity[| type] == 1) // common
	{
		draw_set_color(c_green);
		draw_text(x+227.5, y+70, rarityStringKor(rarity[| type]));
	}
